...
### Enhancements
With this release we have added support for MS Outlook and Apple Contacts applications. Some refactoring has occured, primarily between ```spreads.clj``` and a new namespace ```utility.clj```.
